...
def plot_code_histogram(issues):
    ...
    bars = plt.bar(codes, values, color="skyblue", edgecolor="black")
...
def plot_disease_repartition(issues):
    disease_counts = Counter(issue.get("disease", "Unknown") for issue in issues)
...
def plot_code_histogram_comparison(issues1, issues2, label1="GPT-4o", label2="GPT-4o-mini"):
...
def plot_disease_repartition_comparison(issues1, issues2, label1="GPT-4o", label2="GPT-4o-mini"):
...
def plot_comprehensive_comparison():
    ...
    bars = plt.bar(codes, values, color="lightcoral", edgecolor="black")
    plt.xlabel("Error/Warning Code")
    plt.ylabel("Count")
